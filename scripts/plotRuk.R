...
plot <- ggplot(df, aes(
  ...
  labs(
    title = "Rozkłady długości skoków w wybranych konkursach Pucharu Świata w Ruce",
    x = "Konkurs (numer konkursu w roku, sezon)",
    y = "Długość skoku (m)",
  )


ggsave(filename = "../plots/plotRuk.jpg", plot = plot, width = 10, height = 6, dpi = 300)
